...
class RobustRotationEstimator:
    ...
    def __init__(self,
        ...
        self.shift = 0 # To shift the bins
        self.n_points = 1 # The lines of compatible rotations are discretized so that there is approx. one point per bin.
    ...
    def _precompute_lines_vectorized(self):
        ...
        # self.n_points times more points than bins
    ...
    def estimate(self, flow):
        """
        Estimate the camera rotation for the optical flow
        :param flow: np.array Optical flow (h, w, 2)
        :return: Estimated camera rotation as rotvec in rad.
        """
